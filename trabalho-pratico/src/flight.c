...
Flight *RetrieveFlight(hash_flight h, char *id) {
	 int i = Hash_flight(id);
	 Flight *res;
...
void InsertTable_flight(hash_flight h, char *id, char *airline, char *plane_model, char *total_seats, char *origin, char *destination, char *schedule_departure_date, char *schedule_arrival_date, char *real_departure_date, char *real_arrival_date, char *pilot, char *copilot, char *notes, char *passengers_number) {
    ...
    novo_voo->passengers_number = strdup(passengers_number);
    novo_voo->next = NULL;
